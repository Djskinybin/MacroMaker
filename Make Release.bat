...
if exist "dist\MacroMaker-Portable-v1.1.0.zip" del /q "dist\MacroMaker-Portable-v1.1.0.zip"
if exist "dist\MacroMaker-Setup.exe" del /q "dist\MacroMaker-Setup.exe"
echo Creating portable ZIP...
powershell -NoProfile -ExecutionPolicy Bypass -Command "Compress-Archive -Path 'dist\MacroMaker.exe' -DestinationPath 'dist\MacroMaker-Portable-v1.1.0.zip' -Force"
if errorlevel 1 (
...
echo dist\MacroMaker-Portable-v1.1.0.zip
